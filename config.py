...
ROBOT_START_POSITIONS = [
    (9.5, 15.5),   # Robot 0 の初期位置
    (10.5, 15.5),  # Robot 1 の初期位置
]
...
UNKNOWN_PENALTY = 1.0  # 未知領域を通過する際のコストペナルティ係数（1.0 = ペナルティなし）
MAX_REPLAN_COUNT = 10  # 経路再計画の最大回数（超えるとタスクをスキップ）
...
#  TestMAP.csv パス設定
# ---------------------------
TESTMAP_CSV_PATH = "maps/Unit1_1F_ver2_concrete.csv"
...
#  実験バージョン名
# ---------------------------
EXPERIMENT_VERSION = "Unit1_1F_ver2_concrete"   # 実験バージョン名
